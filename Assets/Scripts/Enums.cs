...
namespace Enums {
	...
	public enum ProgressCardName { ALCHEMIST, CRANE, ENGINEER, INVENTOR,
		...
		SMITH, BISHOP, CONSTITUTION, DIPLOMAT, INTRIGUE, 
		SABOTEUR, SPY, WARLORD, MERCHANT, MERCHANTFLEET,
	...
	public enum MoveType { MOVE_KNIGHT, DISPLACE_KNIGHT, UPGRADE_KNIGHT, 
		...
		PROGRESS_SPY, PROGRESS_MERCHANT_FLEET, PROGRESS_MERCHANT, PROGRESS_SMITH_1,
		PROGRESS_SMITH_2, TRADE_WITH_BANK, TRADE_WITH_PLAYER, SPECIAL, NONE}
